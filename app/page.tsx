    ...
    <main className="pb-8">
      ...
      <div className="flex flex-col lg:flex-row font-light lg:px-48 pt-1">
        <div className="flex-row w-full lg:w-4/6 items-center px-4">
          <h1 className="text-4xl 2xl:text-5xl py-2">Hi there!</h1>
          <p className="font-light 2xl:text-xl">My name is Jason Cala. I am currently a Computer Science and Biology undergraduate student at University of Windsor on exchange in Tokyo, Japan 🇯🇵.
          I am passionate about Full-Stack, Mobile, AI and ML.</p>
        ...
        <div className="flex-row w-full lg:w-2/6 items-center px-4">
          ...
          <div className="flex w-full space-x-2 py-1">
            <button 
              ...
              >
              <Link href="https://github.com/jasoncala" className="flex"> 
                <svg
            ...
            <button 
              ...
              >
              <Link href="https://www.linkedin.com/in/jason-cala" className="flex">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="mr-2 h-3.5 w-3.5"
                  fill="currentColor"
            ...
            <button 
              ...
              >
                <p className="whitespace-nowrap">✉️ Email me! :)</p>
            </button>
          </div>
          <p>Spotify listening + goodreads + fun stuff</p>
        </div>
